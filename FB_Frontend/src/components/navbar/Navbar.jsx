...
function Navbar() {
  ...
  return (
    <nav className="bg-gray-100 border-gray-200 shadow sticky top-0 left-0 z-20">
      <div className="flex flex-wrap items-center justify-between mx-auto px-4 md:px-12 h-12">
        <a href="/" className="flex items-center">
          <span className="text-xl md:text-2xl font-medium whitespace-nowrap">
            <span className="text-blue-500 font-bold">F</span>armers
            <span className="text-blue-500 font-bold">B</span>azaar
          </span>
        </a>
        <div className="flex flex-row gap-4 md:gap-8 text-2xl md:text-3xl">
          ...
          <div
            className="flex flex-row gap-1 justify-center items-center text-red-600 cursor-pointer"
            onClick={() => {
              setOpenCart(true);
            }}
          >
